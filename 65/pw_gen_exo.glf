...
set _TMP(mode_2) [pw::Application begin GridImport]
  $_TMP(mode_2) initialize -type Automatic {/Users/mhenryde/wind/backStep/65/backstep5_3levdn.cgns}
  $_TMP(mode_2) read
  $_TMP(mode_2) convert
$_TMP(mode_2) end
unset _TMP(mode_2)
...
unset _TMP(PW_145)
unset _TMP(PW_146)
pw::Application save {/Users/mhenryde/wind/backStep/65/backstep5_3levdn.pw}
set _TMP(mode_3) [pw::Application begin CaeExport [pw::Entity sort [list $_BL(1) $_BL(2) $_BL(3) $_BL(4)]]]
  $_TMP(mode_3) initialize -type CAE {/Users/mhenryde/wind/backStep/65/backstep5_3levdn.exo}
