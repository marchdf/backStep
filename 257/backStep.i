...
realms:
  ...
  - name: realm_1
    mesh: backstep5_1levdn_ndtw.exo
    use_edges: yes
    ...
    - type: surface
      ...
      output_file_name: results/backStep.dat
      frequency: 1000
      parameters: [0,0]
      target_name: bottomwall

    output:
      output_data_base_name: results/backStep.e
    ...
    restart:
      restart_data_base_name: restart/backStep.rst
